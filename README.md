...
1. Run the Flattener on your figure to remove groups that may have been generated by the plotting program.
2. Group the elements of each plot into a single group (a grouped plot).
5. Select your grouped plots and run the Scaler.
